...
public class TC_39 extends BaseTest {

    private static final Logger log = LoggerFactory.getLogger(TC_39.class);
    ...
    public void test() {
        ...
        List<Employee> result = employeeDao.sortEmployeeByBirthDate();
        ...
        log.info("TC_39 test run successful");
    }
}

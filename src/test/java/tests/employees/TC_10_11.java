...
public class TC_10_11 extends BaseTest {

    private static final Logger log = LoggerFactory.getLogger(TC_10_11.class);
    ...
    public void test() {
        ...
        log.info("TC_10_11 test finished successfully");
    }
}
